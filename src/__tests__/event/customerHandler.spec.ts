...
import CustomerAddressUpdatedEvent from "../../domain/event/customer/customerAddressUpdatedEvent.event";
import CustomerCreatedEvent from "../../domain/event/customer/customerCreated.event";
import sendConsole2WhenCustomerIsCreatedHandler from "../../domain/event/customer/handle/sendConsole2WhenCustomerIsCreated.handler";
import sendConsoleWhenCustomerAddressIsUpdatedHandler from "../../domain/event/customer/handle/sendConsoleWhenCustomerAddressIsUpdated.handler";
import sendConsoleWhenCustomerIsCreatedHandler from "../../domain/event/customer/handle/sendConsoleWhenCustomerIsCreatedHandler";
